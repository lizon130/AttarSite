                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="SubCategoryId" class="form-label">Sub Category <span
                                        class="text-danger">*</span></label>
                                <select class="form-select @error('SubCategoryId') is-invalid @enderror" id="SubCategoryId"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('ProductDetails') is-invalid @enderror" id="ProductDetails" name="ProductDetails"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" min="0"
                                    class="form-control @error('OfferPrice') is-invalid @enderror" id="OfferPrice"
                                    name="OfferPrice" value="{{ old('OfferPrice') }}" placeholder="0.00">
                                @error('OfferPrice')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ProductSize') is-invalid @enderror"
                                    id="ProductSize" name="ProductSize" value="{{ old('ProductSize') }}"
