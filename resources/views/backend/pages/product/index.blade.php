                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-3">
                                <button type="button" id="resetFilter"
                                    class="btn btn-sm btn-secondary w-100">Reset</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    ...
                                    $('#categoryFilter').closest('.col-md-6').after(
                                        '<div class="col-md-6" id="subcategoryContainer">' + html +
                                        '</div>');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.badge.bg-secondary').text('Set Primary').removeClass('badge').addClass(
                                'btn btn-sm btn-outline-primary set-primary');
